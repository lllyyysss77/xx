...
export default function ActivityDetailPage() {
  ...
  const getStageDisplayStatus = (s: FiefStage) => {
    if (s.endDate && s.endDate < todayStr) return 'done';
    if (s.startDate && s.endDate && todayStr >= s.startDate && todayStr <= s.endDate) return 'current';
    return 'todo';
  };
          ...
          <div className={Style.card}>
            ...
            <Timeline mode="same" className={Style.timeline}>
              {stages.map((s) => {
                ...
                const dotColor =
                  ss === 'current' ? '#D54941' : ss === 'done' ? '#2BA471' : '#D4D0CA';
                ...
                return (
                  ...
                  >
                    <div
                      className={`${Style.stageCard} ${isSelected ? Style.stageSelected : ''}`}
                      onClick={() => {
                    ...
                    >
                      <div className={Style.stageHead}>
                        ...
                        {ss === 'current' && <Tag size="small" theme="danger" variant="light">进行中</Tag>}
                        {ss === 'done' && <Tag size="small" theme="success" variant="light">已完成</Tag>}
                        {isSelected && <Tag size="small" theme="warning" variant="dark">编辑中</Tag>}
                      </div>
            ...
            {stageNoticeNos.length === 0 ? (
              ...
              <div>
                ...
                <div className={Style.wbField}>
                  ...
                  <Input value={editTitle} onChange={setEditTitle} placeholder="请输入公告标题" />
                </div>
                ...
                <div className={Style.wbField}>
                  ...
                  <div className={Style.wbBtns}>
                    <Button size="small" variant="outline" icon={<BrowseIcon />} onClick={() => setPreviewVisible(true)}>
                      预览红头大字排版
                    </Button>
                ...
                <div className={Style.wbField}>
                  ...
                  <div className={Style.wbRow} style={{ marginTop: 14 }}>
                    <Switch value={openMaterial} onChange={setOpenMaterial} />
                ...
                <div className={Style.wbPublish}>
                  ...
                  <Radio.Group value={publishMode} onChange={(v: any) => setPublishMode(v)}>
